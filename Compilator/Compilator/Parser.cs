...
// GPPG version 1.5.2
// Machine:  WG
// DateTime: 28.06.2020 22:35:29
// UserName: HP
// Input file <E:\MetodyTranslacji\github\Compilator\Compilator\kompilator.y - 28.06.2020 19:37:30>
...
{
  // Verbatim content from E:\MetodyTranslacji\github\Compilator\Compilator\kompilator.y - 28.06.2020 19:37:30
#line 7 "E:\MetodyTranslacji\github\Compilator\Compilator\kompilator.y"
	public Program MyProgram {get; set;}	
#line default
  // End verbatim content from E:\MetodyTranslacji\github\Compilator\Compilator\kompilator.y - 28.06.2020 19:37:30
...
#pragma warning restore 649
  ...
  static Parser() {
    states[0] = new State(new int[]{4,4,2,115},new int[]{-14,1,-16,3});
    states[1] = new State(new int[]{3,2});
    states[2] = new State(-1);
    states[3] = new State(-2);
    states[4] = new State(new int[]{35,5});
    states[5] = new State(new int[]{36,11,39,14,13,106,11,109,12,112,35,17,7,21,10,26,9,28,5,90,40,33,33,47,31,62,32,63,28,64,2,65,41,68,42,69,14,71,15,72,8,99},new int[]{-17,6,-1,7,-13,102,-2,104,-12,15,-6,97,-7,36,-8,89,-9,84,-10,75,-5,74,-4,73,-11,60,-3,67});
    states[6] = new State(-3);
    states[7] = new State(new int[]{36,11,39,14,35,17,7,21,10,26,9,28,5,90,40,33,33,47,31,62,32,63,28,64,2,65,41,68,42,69,14,71,15,72,8,99},new int[]{-17,8,-13,9,-12,15,-6,97,-7,36,-8,89,-9,84,-10,75,-5,74,-4,73,-11,60,-3,67});
    ...
    states[15] = new State(new int[]{35,17,7,21,10,26,9,28,5,90,40,33,33,47,31,62,32,63,28,64,2,65,41,68,42,69,14,71,15,72,8,99,36,-17,39,-17},new int[]{-13,16,-12,15,-6,97,-7,36,-8,89,-9,84,-10,75,-5,74,-4,73,-11,60,-3,67});
    states[16] = new State(-16);
    states[17] = new State(new int[]{36,20,35,17,7,21,10,26,9,28,5,90,40,33,33,47,31,62,32,63,28,64,2,65,41,68,42,69,14,71,15,72,8,99},new int[]{-13,18,-12,15,-6,97,-7,36,-8,89,-9,84,-10,75,-5,74,-4,73,-11,60,-3,67});
    states[18] = new State(new int[]{36,19});
    states[19] = new State(-18);
    states[20] = new State(-19);
    states[21] = new State(new int[]{33,22});
    states[22] = new State(new int[]{40,33,33,47,31,62,32,63,28,64,2,65,41,68,42,69,14,71,15,72},new int[]{-6,23,-7,36,-8,89,-9,84,-10,75,-5,74,-4,73,-11,60,-3,67});
    states[23] = new State(new int[]{34,24});
    states[24] = new State(new int[]{35,17,7,21,10,26,9,28,5,90,40,33,33,47,31,62,32,63,28,64,2,65,41,68,42,69,14,71,15,72,8,99},new int[]{-12,25,-6,97,-7,36,-8,89,-9,84,-10,75,-5,74,-4,73,-11,60,-3,67});
    states[25] = new State(-20);
    states[26] = new State(new int[]{38,27});
    states[27] = new State(-21);
    states[28] = new State(new int[]{43,31,40,33,33,47,31,62,32,63,28,64,2,65,41,68,42,69,14,71,15,72},new int[]{-6,29,-7,36,-8,89,-9,84,-10,75,-5,74,-4,73,-11,60,-3,67});
    ...
    states[34] = new State(new int[]{40,33,33,47,31,62,32,63,28,64,2,65,41,68,42,69,14,71,15,72},new int[]{-6,35,-7,36,-8,89,-9,84,-10,75,-5,74,-4,73,-11,60,-3,67});
    states[35] = new State(-28);
    states[36] = new State(new int[]{17,37,18,50,38,-29,34,-29});
    states[37] = new State(new int[]{33,47,31,62,32,63,28,64,2,65,41,68,42,69,40,70,14,71,15,72},new int[]{-8,38,-9,84,-10,75,-5,74,-4,73,-11,60,-3,67});
    states[38] = new State(new int[]{21,39,22,52,23,76,24,78,25,80,26,82,17,-30,18,-30,38,-30,34,-30});
    states[39] = new State(new int[]{33,47,31,62,32,63,28,64,2,65,41,68,42,69,40,70,14,71,15,72},new int[]{-9,40,-10,75,-5,74,-4,73,-11,60,-3,67});
    states[40] = new State(new int[]{27,41,28,54,21,-33,22,-33,23,-33,24,-33,25,-33,26,-33,17,-33,18,-33,38,-33,34,-33});
    states[41] = new State(new int[]{33,47,31,62,32,63,28,64,2,65,41,68,42,69,40,70,14,71,15,72},new int[]{-10,42,-5,74,-4,73,-11,60,-3,67});
    states[42] = new State(new int[]{29,43,30,56,27,-40,28,-40,21,-40,22,-40,23,-40,24,-40,25,-40,26,-40,17,-40,18,-40,38,-40,34,-40});
    states[43] = new State(new int[]{33,47,31,62,32,63,28,64,2,65,41,68,42,69,40,70,14,71,15,72},new int[]{-5,44,-4,73,-11,60,-3,67});
    states[44] = new State(new int[]{19,45,20,58,29,-43,30,-43,27,-43,28,-43,21,-43,22,-43,23,-43,24,-43,25,-43,26,-43,17,-43,18,-43,38,-43,34,-43});
    states[45] = new State(new int[]{33,47,31,62,32,63,28,64,2,65,41,68,42,69,40,70,14,71,15,72},new int[]{-4,46,-11,60,-3,67});
    states[46] = new State(-46);
    states[47] = new State(new int[]{11,85,12,87,33,47,31,62,32,63,28,64,2,65,41,68,42,69,40,70,14,71,15,72},new int[]{-7,48,-8,89,-9,84,-10,75,-5,74,-4,73,-11,60,-3,67});
    states[48] = new State(new int[]{34,49,17,37,18,50});
    states[49] = new State(-49);
    states[50] = new State(new int[]{33,47,31,62,32,63,28,64,2,65,41,68,42,69,40,70,14,71,15,72},new int[]{-8,51,-9,84,-10,75,-5,74,-4,73,-11,60,-3,67});
    states[51] = new State(new int[]{21,39,22,52,23,76,24,78,25,80,26,82,17,-31,18,-31,38,-31,34,-31});
    states[52] = new State(new int[]{33,47,31,62,32,63,28,64,2,65,41,68,42,69,40,70,14,71,15,72},new int[]{-9,53,-10,75,-5,74,-4,73,-11,60,-3,67});
    states[53] = new State(new int[]{27,41,28,54,21,-34,22,-34,23,-34,24,-34,25,-34,26,-34,17,-34,18,-34,38,-34,34,-34});
    states[54] = new State(new int[]{33,47,31,62,32,63,28,64,2,65,41,68,42,69,40,70,14,71,15,72},new int[]{-10,55,-5,74,-4,73,-11,60,-3,67});
    states[55] = new State(new int[]{29,43,30,56,27,-41,28,-41,21,-41,22,-41,23,-41,24,-41,25,-41,26,-41,17,-41,18,-41,38,-41,34,-41});
    states[56] = new State(new int[]{33,47,31,62,32,63,28,64,2,65,41,68,42,69,40,70,14,71,15,72},new int[]{-5,57,-4,73,-11,60,-3,67});
    states[57] = new State(new int[]{19,45,20,58,29,-44,30,-44,27,-44,28,-44,21,-44,22,-44,23,-44,24,-44,25,-44,26,-44,17,-44,18,-44,38,-44,34,-44});
    states[58] = new State(new int[]{33,47,31,62,32,63,28,64,2,65,41,68,42,69,40,70,14,71,15,72},new int[]{-4,59,-11,60,-3,67});
    states[59] = new State(-47);
    states[60] = new State(new int[]{33,47,31,62,32,63,28,64,2,65,41,68,42,69,40,70,14,71,15,72},new int[]{-4,61,-11,60,-3,67});
    ...
    states[74] = new State(new int[]{19,45,20,58,29,-45,30,-45,27,-45,28,-45,21,-45,22,-45,23,-45,24,-45,25,-45,26,-45,17,-45,18,-45,38,-45,34,-45});
    states[75] = new State(new int[]{29,43,30,56,27,-42,28,-42,21,-42,22,-42,23,-42,24,-42,25,-42,26,-42,17,-42,18,-42,38,-42,34,-42});
    states[76] = new State(new int[]{33,47,31,62,32,63,28,64,2,65,41,68,42,69,40,70,14,71,15,72},new int[]{-9,77,-10,75,-5,74,-4,73,-11,60,-3,67});
    states[77] = new State(new int[]{27,41,28,54,21,-35,22,-35,23,-35,24,-35,25,-35,26,-35,17,-35,18,-35,38,-35,34,-35});
    states[78] = new State(new int[]{33,47,31,62,32,63,28,64,2,65,41,68,42,69,40,70,14,71,15,72},new int[]{-9,79,-10,75,-5,74,-4,73,-11,60,-3,67});
    states[79] = new State(new int[]{27,41,28,54,21,-36,22,-36,23,-36,24,-36,25,-36,26,-36,17,-36,18,-36,38,-36,34,-36});
    states[80] = new State(new int[]{33,47,31,62,32,63,28,64,2,65,41,68,42,69,40,70,14,71,15,72},new int[]{-9,81,-10,75,-5,74,-4,73,-11,60,-3,67});
    states[81] = new State(new int[]{27,41,28,54,21,-37,22,-37,23,-37,24,-37,25,-37,26,-37,17,-37,18,-37,38,-37,34,-37});
    states[82] = new State(new int[]{33,47,31,62,32,63,28,64,2,65,41,68,42,69,40,70,14,71,15,72},new int[]{-9,83,-10,75,-5,74,-4,73,-11,60,-3,67});
    states[83] = new State(new int[]{27,41,28,54,21,-38,22,-38,23,-38,24,-38,25,-38,26,-38,17,-38,18,-38,38,-38,34,-38});
    states[84] = new State(new int[]{27,41,28,54,21,-39,22,-39,23,-39,24,-39,25,-39,26,-39,17,-39,18,-39,38,-39,34,-39});
    states[85] = new State(new int[]{34,86});
    states[86] = new State(-60);
    states[87] = new State(new int[]{34,88});
    states[88] = new State(-61);
    states[89] = new State(new int[]{21,39,22,52,23,76,24,78,25,80,26,82,17,-32,18,-32,38,-32,34,-32});
    states[90] = new State(new int[]{33,91});
    states[91] = new State(new int[]{40,33,33,47,31,62,32,63,28,64,2,65,41,68,42,69,14,71,15,72},new int[]{-6,92,-7,36,-8,89,-9,84,-10,75,-5,74,-4,73,-11,60,-3,67});
    states[92] = new State(new int[]{34,93});
    states[93] = new State(new int[]{35,17,7,21,10,26,9,28,5,90,40,33,33,47,31,62,32,63,28,64,2,65,41,68,42,69,14,71,15,72,8,99},new int[]{-12,94,-6,97,-7,36,-8,89,-9,84,-10,75,-5,74,-4,73,-11,60,-3,67});
    states[94] = new State(new int[]{6,95,35,-24,7,-24,10,-24,9,-24,5,-24,40,-24,33,-24,31,-24,32,-24,28,-24,2,-24,41,-24,42,-24,14,-24,15,-24,8,-24,36,-24,39,-24});
    states[95] = new State(new int[]{35,17,7,21,10,26,9,28,5,90,40,33,33,47,31,62,32,63,28,64,2,65,41,68,42,69,14,71,15,72,8,99},new int[]{-12,96,-6,97,-7,36,-8,89,-9,84,-10,75,-5,74,-4,73,-11,60,-3,67});
    ...
    states[102] = new State(new int[]{36,11,39,14},new int[]{-17,103});
    states[103] = new State(-6);
    states[104] = new State(new int[]{13,106,11,109,12,112,36,-12,39,-12,35,-12,7,-12,10,-12,9,-12,5,-12,40,-12,33,-12,31,-12,32,-12,28,-12,2,-12,41,-12,42,-12,14,-12,15,-12,8,-12},new int[]{-1,105,-2,104});
    ...
    rules[49] = new Rule(-4, new int[]{33,-7,34});
    ...
    rules[62] = new Rule(-11, new int[]{2,38});
...
#line default
        break;
      case 49: // operation -> OpenPar, exp, ClosePar
...
#line default
        break;
      case 62: // simpleoperation -> error, Semicolon
