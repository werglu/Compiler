...
// GPPG version 1.5.2
// Machine:  WG
// DateTime: 25.06.2020 22:38:49
// UserName: HP
// Input file <E:\MetodyTranslacji\github\Compilator\Compilator\kompilator.y - 25.06.2020 22:38:45>
...
#line 14 "E:\MetodyTranslacji\github\Compilator\Compilator\kompilator.y"
{
public string  val;
public char    type;
...
{
  // Verbatim content from E:\MetodyTranslacji\github\Compilator\Compilator\kompilator.y - 25.06.2020 22:38:45
#line 8 "E:\MetodyTranslacji\github\Compilator\Compilator\kompilator.y"
	public Program MyProgram {get; set;}
	

#line default
  // End verbatim content from E:\MetodyTranslacji\github\Compilator\Compilator\kompilator.y - 25.06.2020 22:38:45
...
#pragma warning restore 649
  ...
  private static string[] nonTerms = new string[] {
      "declarations", "declaration", "number", "operation", "simpleoperation", 
      "start", "$accept", "line", "end", "statement", "statement1", "expresion", 
      "exp", "exp2", "exp3", "term", "bitwiseoperation", "err", };

  static Parser() {
    states[0] = new State(new int[]{4,4,2,116},new int[]{-6,1,-8,3});
    states[1] = new State(new int[]{3,2});
    states[2] = new State(-1);
    states[3] = new State(-2);
    states[4] = new State(new int[]{35,5});
    states[5] = new State(new int[]{36,11,39,14,13,107,11,110,12,113,35,17,7,21,10,26,38,28,9,29,5,91,40,34,33,47,31,62,32,63,28,64,41,66,42,67,14,69,15,70,8,100},new int[]{-9,6,-1,7,-10,103,-2,105,-11,15,-12,98,-13,90,-14,89,-15,82,-16,73,-17,72,-4,71,-5,60,-3,65});
    states[6] = new State(-3);
    states[7] = new State(new int[]{36,11,39,14,35,17,7,21,10,26,38,28,9,29,5,91,40,34,33,47,31,62,32,63,28,64,41,66,42,67,14,69,15,70,8,100},new int[]{-9,8,-10,9,-11,15,-12,98,-13,90,-14,89,-15,82,-16,73,-17,72,-4,71,-5,60,-3,65});
    states[8] = new State(-4);
    states[9] = new State(new int[]{36,11,39,14},new int[]{-9,10});
    ...
    states[15] = new State(new int[]{35,17,7,21,10,26,38,28,9,29,5,91,40,34,33,47,31,62,32,63,28,64,41,66,42,67,14,69,15,70,8,100,36,-17,39,-17},new int[]{-10,16,-11,15,-12,98,-13,90,-14,89,-15,82,-16,73,-17,72,-4,71,-5,60,-3,65});
    states[16] = new State(-16);
    states[17] = new State(new int[]{36,20,35,17,7,21,10,26,38,28,9,29,5,91,40,34,33,47,31,62,32,63,28,64,41,66,42,67,14,69,15,70,8,100},new int[]{-11,18,-12,98,-13,90,-14,89,-15,82,-16,73,-17,72,-4,71,-5,60,-3,65});
    states[18] = new State(new int[]{36,19});
    states[19] = new State(-18);
    states[20] = new State(-19);
    states[21] = new State(new int[]{33,22});
    states[22] = new State(new int[]{40,34,33,47,31,62,32,63,28,64,41,66,42,67,14,69,15,70},new int[]{-12,23,-13,90,-14,89,-15,82,-16,73,-17,72,-4,71,-5,60,-3,65});
    states[23] = new State(new int[]{34,24});
    states[24] = new State(new int[]{35,17,7,21,10,26,38,28,9,29,5,91,40,34,33,47,31,62,32,63,28,64,41,66,42,67,14,69,15,70,8,100},new int[]{-11,25,-12,98,-13,90,-14,89,-15,82,-16,73,-17,72,-4,71,-5,60,-3,65});
    states[25] = new State(-20);
    states[26] = new State(new int[]{38,27});
    states[27] = new State(-21);
    states[28] = new State(-22);
    states[29] = new State(new int[]{43,32,40,34,33,47,31,62,32,63,28,64,41,66,42,67,14,69,15,70},new int[]{-12,30,-13,90,-14,89,-15,82,-16,73,-17,72,-4,71,-5,60,-3,65});
    ...
    states[35] = new State(new int[]{33,47,31,62,32,63,28,64,41,66,42,67,40,68,14,69,15,70},new int[]{-13,36,-14,89,-15,82,-16,73,-17,72,-4,71,-5,60,-3,65});
    states[36] = new State(new int[]{17,37,18,50,38,-29,34,-29});
    states[37] = new State(new int[]{33,47,31,62,32,63,28,64,41,66,42,67,40,68,14,69,15,70},new int[]{-14,38,-15,82,-16,73,-17,72,-4,71,-5,60,-3,65});
    states[38] = new State(new int[]{21,39,22,52,23,74,24,76,25,78,26,80,17,-31,18,-31,38,-31,34,-31});
    states[39] = new State(new int[]{33,47,31,62,32,63,28,64,41,66,42,67,40,68,14,69,15,70},new int[]{-15,40,-16,73,-17,72,-4,71,-5,60,-3,65});
    states[40] = new State(new int[]{27,41,28,54,21,-34,22,-34,23,-34,24,-34,25,-34,26,-34,17,-34,18,-34,38,-34,34,-34});
    states[41] = new State(new int[]{33,47,31,62,32,63,28,64,41,66,42,67,40,68,14,69,15,70},new int[]{-16,42,-17,72,-4,71,-5,60,-3,65});
    states[42] = new State(new int[]{29,43,30,56,27,-41,28,-41,21,-41,22,-41,23,-41,24,-41,25,-41,26,-41,17,-41,18,-41,38,-41,34,-41});
    states[43] = new State(new int[]{33,47,31,62,32,63,28,64,41,66,42,67,40,68,14,69,15,70},new int[]{-17,44,-4,71,-5,60,-3,65});
    ...
    states[45] = new State(new int[]{33,47,31,62,32,63,28,64,41,66,42,67,40,68,14,69,15,70},new int[]{-4,46,-5,60,-3,65});
    states[46] = new State(-47);
    states[47] = new State(new int[]{13,83,11,85,12,87,33,47,31,62,32,63,28,64,41,66,42,67,40,68,14,69,15,70},new int[]{-13,48,-14,89,-15,82,-16,73,-17,72,-4,71,-5,60,-3,65});
    states[48] = new State(new int[]{34,49,17,37,18,50});
    states[49] = new State(-50);
    states[50] = new State(new int[]{33,47,31,62,32,63,28,64,41,66,42,67,40,68,14,69,15,70},new int[]{-14,51,-15,82,-16,73,-17,72,-4,71,-5,60,-3,65});
    states[51] = new State(new int[]{21,39,22,52,23,74,24,76,25,78,26,80,17,-32,18,-32,38,-32,34,-32});
    states[52] = new State(new int[]{33,47,31,62,32,63,28,64,41,66,42,67,40,68,14,69,15,70},new int[]{-15,53,-16,73,-17,72,-4,71,-5,60,-3,65});
    states[53] = new State(new int[]{27,41,28,54,21,-35,22,-35,23,-35,24,-35,25,-35,26,-35,17,-35,18,-35,38,-35,34,-35});
    states[54] = new State(new int[]{33,47,31,62,32,63,28,64,41,66,42,67,40,68,14,69,15,70},new int[]{-16,55,-17,72,-4,71,-5,60,-3,65});
    states[55] = new State(new int[]{29,43,30,56,27,-42,28,-42,21,-42,22,-42,23,-42,24,-42,25,-42,26,-42,17,-42,18,-42,38,-42,34,-42});
    states[56] = new State(new int[]{33,47,31,62,32,63,28,64,41,66,42,67,40,68,14,69,15,70},new int[]{-17,57,-4,71,-5,60,-3,65});
    ...
    states[58] = new State(new int[]{33,47,31,62,32,63,28,64,41,66,42,67,40,68,14,69,15,70},new int[]{-4,59,-5,60,-3,65});
    states[59] = new State(-48);
    states[60] = new State(new int[]{33,47,31,62,32,63,28,64,41,66,42,67,40,68,14,69,15,70},new int[]{-4,61,-5,60,-3,65});
    ...
    states[74] = new State(new int[]{33,47,31,62,32,63,28,64,41,66,42,67,40,68,14,69,15,70},new int[]{-15,75,-16,73,-17,72,-4,71,-5,60,-3,65});
    states[75] = new State(new int[]{27,41,28,54,21,-36,22,-36,23,-36,24,-36,25,-36,26,-36,17,-36,18,-36,38,-36,34,-36});
    states[76] = new State(new int[]{33,47,31,62,32,63,28,64,41,66,42,67,40,68,14,69,15,70},new int[]{-15,77,-16,73,-17,72,-4,71,-5,60,-3,65});
    states[77] = new State(new int[]{27,41,28,54,21,-37,22,-37,23,-37,24,-37,25,-37,26,-37,17,-37,18,-37,38,-37,34,-37});
    states[78] = new State(new int[]{33,47,31,62,32,63,28,64,41,66,42,67,40,68,14,69,15,70},new int[]{-15,79,-16,73,-17,72,-4,71,-5,60,-3,65});
    states[79] = new State(new int[]{27,41,28,54,21,-38,22,-38,23,-38,24,-38,25,-38,26,-38,17,-38,18,-38,38,-38,34,-38});
    states[80] = new State(new int[]{33,47,31,62,32,63,28,64,41,66,42,67,40,68,14,69,15,70},new int[]{-15,81,-16,73,-17,72,-4,71,-5,60,-3,65});
    ...
    states[92] = new State(new int[]{40,34,33,47,31,62,32,63,28,64,41,66,42,67,14,69,15,70},new int[]{-12,93,-13,90,-14,89,-15,82,-16,73,-17,72,-4,71,-5,60,-3,65});
    states[93] = new State(new int[]{34,94});
    states[94] = new State(new int[]{35,17,7,21,10,26,38,28,9,29,5,91,40,34,33,47,31,62,32,63,28,64,41,66,42,67,14,69,15,70,8,100},new int[]{-11,95,-12,98,-13,90,-14,89,-15,82,-16,73,-17,72,-4,71,-5,60,-3,65});
    ...
    states[96] = new State(new int[]{35,17,7,21,10,26,38,28,9,29,5,91,40,34,33,47,31,62,32,63,28,64,41,66,42,67,14,69,15,70,8,100},new int[]{-11,97,-12,98,-13,90,-14,89,-15,82,-16,73,-17,72,-4,71,-5,60,-3,65});
    ...
    states[103] = new State(new int[]{36,11,39,14},new int[]{-9,104});
    ...
    rules[3] = new Rule(-8, new int[]{4,35,-9});
    rules[4] = new Rule(-8, new int[]{4,35,-1,-9});
    rules[5] = new Rule(-8, new int[]{4,35,-1,-10,-9});
    rules[6] = new Rule(-8, new int[]{4,35,-10,-9});
    rules[7] = new Rule(-8, new int[]{2});
    rules[8] = new Rule(-9, new int[]{36,37});
    rules[9] = new Rule(-9, new int[]{36,39});
    rules[10] = new Rule(-9, new int[]{39});
    ...
    rules[16] = new Rule(-10, new int[]{-11,-10});
    rules[17] = new Rule(-10, new int[]{-11});
    rules[18] = new Rule(-11, new int[]{35,-11,36});
    rules[19] = new Rule(-11, new int[]{35,36});
    rules[20] = new Rule(-11, new int[]{7,33,-12,34,-11});
    rules[21] = new Rule(-11, new int[]{10,38});
    rules[22] = new Rule(-11, new int[]{38});
    rules[23] = new Rule(-11, new int[]{9,-12,38});
    rules[24] = new Rule(-11, new int[]{9,43,38});
    rules[25] = new Rule(-11, new int[]{5,33,-12,34,-11});
    rules[26] = new Rule(-11, new int[]{5,33,-12,34,-11,6,-11});
    rules[27] = new Rule(-11, new int[]{-12,38});
    rules[28] = new Rule(-11, new int[]{8,40,38});
    rules[29] = new Rule(-12, new int[]{40,16,-13});
    rules[30] = new Rule(-12, new int[]{-13});
    rules[31] = new Rule(-13, new int[]{-13,17,-14});
    rules[32] = new Rule(-13, new int[]{-13,18,-14});
    rules[33] = new Rule(-13, new int[]{-14});
    rules[34] = new Rule(-14, new int[]{-14,21,-15});
    rules[35] = new Rule(-14, new int[]{-14,22,-15});
    rules[36] = new Rule(-14, new int[]{-14,23,-15});
    rules[37] = new Rule(-14, new int[]{-14,24,-15});
    rules[38] = new Rule(-14, new int[]{-14,25,-15});
    rules[39] = new Rule(-14, new int[]{-14,26,-15});
    rules[40] = new Rule(-14, new int[]{-15});
    rules[41] = new Rule(-15, new int[]{-15,27,-16});
    rules[42] = new Rule(-15, new int[]{-15,28,-16});
    rules[43] = new Rule(-15, new int[]{-16});
    rules[44] = new Rule(-16, new int[]{-16,29,-17});
    rules[45] = new Rule(-16, new int[]{-16,30,-17});
    rules[46] = new Rule(-16, new int[]{-17});
    rules[47] = new Rule(-17, new int[]{-17,19,-4});
    rules[48] = new Rule(-17, new int[]{-17,20,-4});
    rules[49] = new Rule(-17, new int[]{-4});
    rules[50] = new Rule(-4, new int[]{33,-13,34});
    rules[51] = new Rule(-4, new int[]{-5,-4});
    ...
    rules[58] = new Rule(-5, new int[]{31});
    rules[59] = new Rule(-5, new int[]{32});
    rules[60] = new Rule(-5, new int[]{28});
    rules[61] = new Rule(-5, new int[]{33,13,34});
    rules[62] = new Rule(-5, new int[]{33,11,34});
    rules[63] = new Rule(-5, new int[]{33,12,34});
