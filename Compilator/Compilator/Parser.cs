...
#pragma warning restore 649
  ...
  static Parser() {
    ...
    states[5] = new State(new int[]{36,11,39,14,13,106,11,109,12,112,35,17,7,21,10,26,9,28,5,90,40,33,33,46,31,61,32,62,28,63,2,64,41,67,42,68,14,70,15,71,8,99},new int[]{-17,6,-1,7,-13,102,-2,104,-12,15,-6,97,-7,89,-8,88,-9,83,-10,74,-5,73,-4,72,-11,59,-3,66});
    states[6] = new State(-3);
    states[7] = new State(new int[]{36,11,39,14,35,17,7,21,10,26,9,28,5,90,40,33,33,46,31,61,32,62,28,63,2,64,41,67,42,68,14,70,15,71,8,99},new int[]{-17,8,-13,9,-12,15,-6,97,-7,89,-8,88,-9,83,-10,74,-5,73,-4,72,-11,59,-3,66});
    ...
    states[15] = new State(new int[]{35,17,7,21,10,26,9,28,5,90,40,33,33,46,31,61,32,62,28,63,2,64,41,67,42,68,14,70,15,71,8,99,36,-17,39,-17},new int[]{-13,16,-12,15,-6,97,-7,89,-8,88,-9,83,-10,74,-5,73,-4,72,-11,59,-3,66});
    states[16] = new State(-16);
    states[17] = new State(new int[]{36,20,35,17,7,21,10,26,9,28,5,90,40,33,33,46,31,61,32,62,28,63,2,64,41,67,42,68,14,70,15,71,8,99},new int[]{-13,18,-12,15,-6,97,-7,89,-8,88,-9,83,-10,74,-5,73,-4,72,-11,59,-3,66});
    states[18] = new State(new int[]{36,19});
    states[19] = new State(-18);
    states[20] = new State(-19);
    states[21] = new State(new int[]{33,22});
    states[22] = new State(new int[]{40,33,33,46,31,61,32,62,28,63,2,64,41,67,42,68,14,70,15,71},new int[]{-6,23,-7,89,-8,88,-9,83,-10,74,-5,73,-4,72,-11,59,-3,66});
    states[23] = new State(new int[]{34,24});
    states[24] = new State(new int[]{35,17,7,21,10,26,9,28,5,90,40,33,33,46,31,61,32,62,28,63,2,64,41,67,42,68,14,70,15,71,8,99},new int[]{-12,25,-6,97,-7,89,-8,88,-9,83,-10,74,-5,73,-4,72,-11,59,-3,66});
    states[25] = new State(-20);
    states[26] = new State(new int[]{38,27});
    states[27] = new State(-21);
    states[28] = new State(new int[]{43,31,40,33,33,46,31,61,32,62,28,63,2,64,41,67,42,68,14,70,15,71},new int[]{-6,29,-7,89,-8,88,-9,83,-10,74,-5,73,-4,72,-11,59,-3,66});
    ...
    states[34] = new State(new int[]{33,46,31,61,32,62,28,63,2,64,41,67,42,68,40,69,14,70,15,71},new int[]{-7,35,-8,88,-9,83,-10,74,-5,73,-4,72,-11,59,-3,66});
    states[35] = new State(new int[]{17,36,18,49,38,-28,34,-28});
    states[36] = new State(new int[]{33,46,31,61,32,62,28,63,2,64,41,67,42,68,40,69,14,70,15,71},new int[]{-8,37,-9,83,-10,74,-5,73,-4,72,-11,59,-3,66});
    states[37] = new State(new int[]{21,38,22,51,23,75,24,77,25,79,26,81,17,-30,18,-30,38,-30,34,-30});
    states[38] = new State(new int[]{33,46,31,61,32,62,28,63,2,64,41,67,42,68,40,69,14,70,15,71},new int[]{-9,39,-10,74,-5,73,-4,72,-11,59,-3,66});
    states[39] = new State(new int[]{27,40,28,53,21,-33,22,-33,23,-33,24,-33,25,-33,26,-33,17,-33,18,-33,38,-33,34,-33});
    states[40] = new State(new int[]{33,46,31,61,32,62,28,63,2,64,41,67,42,68,40,69,14,70,15,71},new int[]{-10,41,-5,73,-4,72,-11,59,-3,66});
    states[41] = new State(new int[]{29,42,30,55,27,-40,28,-40,21,-40,22,-40,23,-40,24,-40,25,-40,26,-40,17,-40,18,-40,38,-40,34,-40});
    states[42] = new State(new int[]{33,46,31,61,32,62,28,63,2,64,41,67,42,68,40,69,14,70,15,71},new int[]{-5,43,-4,72,-11,59,-3,66});
    states[43] = new State(new int[]{19,44,20,57,29,-43,30,-43,27,-43,28,-43,21,-43,22,-43,23,-43,24,-43,25,-43,26,-43,17,-43,18,-43,38,-43,34,-43});
    states[44] = new State(new int[]{33,46,31,61,32,62,28,63,2,64,41,67,42,68,40,69,14,70,15,71},new int[]{-4,45,-11,59,-3,66});
    states[45] = new State(-46);
    states[46] = new State(new int[]{11,84,12,86,33,46,31,61,32,62,28,63,2,64,41,67,42,68,40,69,14,70,15,71},new int[]{-7,47,-8,88,-9,83,-10,74,-5,73,-4,72,-11,59,-3,66});
    states[47] = new State(new int[]{34,48,17,36,18,49});
    states[48] = new State(-49);
    states[49] = new State(new int[]{33,46,31,61,32,62,28,63,2,64,41,67,42,68,40,69,14,70,15,71},new int[]{-8,50,-9,83,-10,74,-5,73,-4,72,-11,59,-3,66});
    states[50] = new State(new int[]{21,38,22,51,23,75,24,77,25,79,26,81,17,-31,18,-31,38,-31,34,-31});
    states[51] = new State(new int[]{33,46,31,61,32,62,28,63,2,64,41,67,42,68,40,69,14,70,15,71},new int[]{-9,52,-10,74,-5,73,-4,72,-11,59,-3,66});
    states[52] = new State(new int[]{27,40,28,53,21,-34,22,-34,23,-34,24,-34,25,-34,26,-34,17,-34,18,-34,38,-34,34,-34});
    states[53] = new State(new int[]{33,46,31,61,32,62,28,63,2,64,41,67,42,68,40,69,14,70,15,71},new int[]{-10,54,-5,73,-4,72,-11,59,-3,66});
    states[54] = new State(new int[]{29,42,30,55,27,-41,28,-41,21,-41,22,-41,23,-41,24,-41,25,-41,26,-41,17,-41,18,-41,38,-41,34,-41});
    states[55] = new State(new int[]{33,46,31,61,32,62,28,63,2,64,41,67,42,68,40,69,14,70,15,71},new int[]{-5,56,-4,72,-11,59,-3,66});
    states[56] = new State(new int[]{19,44,20,57,29,-44,30,-44,27,-44,28,-44,21,-44,22,-44,23,-44,24,-44,25,-44,26,-44,17,-44,18,-44,38,-44,34,-44});
    states[57] = new State(new int[]{33,46,31,61,32,62,28,63,2,64,41,67,42,68,40,69,14,70,15,71},new int[]{-4,58,-11,59,-3,66});
    states[58] = new State(-47);
    states[59] = new State(new int[]{33,46,31,61,32,62,28,63,2,64,41,67,42,68,40,69,14,70,15,71},new int[]{-4,60,-11,59,-3,66});
    ...
    states[73] = new State(new int[]{19,44,20,57,29,-45,30,-45,27,-45,28,-45,21,-45,22,-45,23,-45,24,-45,25,-45,26,-45,17,-45,18,-45,38,-45,34,-45});
    states[74] = new State(new int[]{29,42,30,55,27,-42,28,-42,21,-42,22,-42,23,-42,24,-42,25,-42,26,-42,17,-42,18,-42,38,-42,34,-42});
    states[75] = new State(new int[]{33,46,31,61,32,62,28,63,2,64,41,67,42,68,40,69,14,70,15,71},new int[]{-9,76,-10,74,-5,73,-4,72,-11,59,-3,66});
    states[76] = new State(new int[]{27,40,28,53,21,-35,22,-35,23,-35,24,-35,25,-35,26,-35,17,-35,18,-35,38,-35,34,-35});
    states[77] = new State(new int[]{33,46,31,61,32,62,28,63,2,64,41,67,42,68,40,69,14,70,15,71},new int[]{-9,78,-10,74,-5,73,-4,72,-11,59,-3,66});
    states[78] = new State(new int[]{27,40,28,53,21,-36,22,-36,23,-36,24,-36,25,-36,26,-36,17,-36,18,-36,38,-36,34,-36});
    states[79] = new State(new int[]{33,46,31,61,32,62,28,63,2,64,41,67,42,68,40,69,14,70,15,71},new int[]{-9,80,-10,74,-5,73,-4,72,-11,59,-3,66});
    states[80] = new State(new int[]{27,40,28,53,21,-37,22,-37,23,-37,24,-37,25,-37,26,-37,17,-37,18,-37,38,-37,34,-37});
    states[81] = new State(new int[]{33,46,31,61,32,62,28,63,2,64,41,67,42,68,40,69,14,70,15,71},new int[]{-9,82,-10,74,-5,73,-4,72,-11,59,-3,66});
    states[82] = new State(new int[]{27,40,28,53,21,-38,22,-38,23,-38,24,-38,25,-38,26,-38,17,-38,18,-38,38,-38,34,-38});
    states[83] = new State(new int[]{27,40,28,53,21,-39,22,-39,23,-39,24,-39,25,-39,26,-39,17,-39,18,-39,38,-39,34,-39});
    states[84] = new State(new int[]{34,85});
    states[85] = new State(-60);
    states[86] = new State(new int[]{34,87});
    states[87] = new State(-61);
    states[88] = new State(new int[]{21,38,22,51,23,75,24,77,25,79,26,81,17,-32,18,-32,38,-32,34,-32});
    states[89] = new State(new int[]{17,36,18,49,38,-29,34,-29});
    states[90] = new State(new int[]{33,91});
    states[91] = new State(new int[]{40,33,33,46,31,61,32,62,28,63,2,64,41,67,42,68,14,70,15,71},new int[]{-6,92,-7,89,-8,88,-9,83,-10,74,-5,73,-4,72,-11,59,-3,66});
    states[92] = new State(new int[]{34,93});
    states[93] = new State(new int[]{35,17,7,21,10,26,9,28,5,90,40,33,33,46,31,61,32,62,28,63,2,64,41,67,42,68,14,70,15,71,8,99},new int[]{-12,94,-6,97,-7,89,-8,88,-9,83,-10,74,-5,73,-4,72,-11,59,-3,66});
    ...
    states[95] = new State(new int[]{35,17,7,21,10,26,9,28,5,90,40,33,33,46,31,61,32,62,28,63,2,64,41,67,42,68,14,70,15,71,8,99},new int[]{-12,96,-6,97,-7,89,-8,88,-9,83,-10,74,-5,73,-4,72,-11,59,-3,66});
    ...
    rules[28] = new Rule(-6, new int[]{40,16,-7});
...
#line default
        break;
      case 28: // expresion -> Ident, Assign, exp
